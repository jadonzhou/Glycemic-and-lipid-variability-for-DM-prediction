...
def get_blcd(test_size=0.2):
    blcd = pd.read_csv("/Users/jadonzhou/Research Projects/Healthcare Predictives 1/Variable variability studies/DM BMC Endocrine Disorders/Database.csv", engine='python')
